...
int classic_server(int clientnode, int (*callback)(int, unsigned char *, int),
...
int node_server(int clientnode, int (*callback)(int, unsigned char *, int),
                char endchar);

int notify_ctic(int node, int cticn, int notifyflag,
                int (*callback)(int, int, unsigned char *, int));
...
int read_mesh(int *node, unsigned char *inbuf, int bufsize, int exitflag,
              int timeoutms);

int read_node_count(int node, unsigned char *inbuf, int count, int exitflag,
                    int timeoutms);

int read_node_endchar(int node, unsigned char *inbuf, int bufsize, char endchar,
                      int exitflag, int timeoutms);
int read_all_endchar(int *node, unsigned char *inbuf, int bufsize, char endchar,
                     int exitflag, int timeoutms);
